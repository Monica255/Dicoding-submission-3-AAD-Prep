        ...
        fun bind(habit: Habit) {
            ...
            ivPriority.setImageDrawable(
                when(habit.priorityLevel){
                    itemView.resources.getStringArray(R.array.priority_level)[0]->AppCompatResources.getDrawable(itemView.context,R.drawable.ic_priority_high)
                    itemView.resources.getStringArray(R.array.priority_level)[1]->AppCompatResources.getDrawable(itemView.context,R.drawable.ic_priority_medium)
