...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val tvMinute:TextView=itemView.findViewById(R.id.pager_tv_minutes)
        private val img:ImageView=itemView.findViewById(R.id.item_priority_level)
        private val btn:Button=itemView.findViewById(R.id.btn_open_count_down)
